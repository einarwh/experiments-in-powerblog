...
{
	if (region.V.K === region.ab.K)
	{
		return 'on line ' + region.V.K;
	}
	return 'on lines ' + region.V.K + ' through ' + region.ab.K;
}
...
var $author$project$Main$charToDir = function (ch) {
	switch (ch) {
		case '^':
			return 0;
		case '<':
...
var $author$project$Main$isCart = function (ch) {
	var symbols = _List_fromArray(
		['^', '<', 'v', '>']);
	return A2($elm$core$List$member, ch, symbols);
};
...
var $author$project$Main$toIndexedList = function (mine) {
	var yRange = A2(
		$elm$core$List$range,
		0,
		$tortus$elm_array_2d$Array2D$rows(mine) - 1);
	var xRange = A2(
		$elm$core$List$range,
		0,
		$tortus$elm_array_2d$Array2D$columns(mine) - 1);
	return A2(
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							...
							' ',
							A3($tortus$elm_array_2d$Array2D$get, y, x, mine)));
				},
				xRange);
		},
		yRange);
};
var $author$project$Main$findCarts = function (mine) {
	var indexed = $author$project$Main$toIndexedList(mine);
	return A2(
		$elm$core$List$filterMap,
		function (_v0) {
			var pos = _v0.a;
			var ch = _v0.b;
			return $author$project$Main$isCart(ch) ? $elm$core$Maybe$Just(
				{
					w: $author$project$Main$charToDir(ch),
					n: pos,
					L: 0
				}) : $elm$core$Maybe$Nothing;
		},
...
var $author$project$Main$sample2 = '/>-<\\  \n|   |  \n| /<+-\\\n| | | v\n\\>+</ |\n  |   ^\n  \\<->/';
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$toList = function (string) {
	return A3($elm$core$String$foldr, $elm$core$List$cons, _List_Nil, string);
};
var $author$project$Main$initMine = function (dataSource) {
	var data = function () {
		switch (dataSource) {
			case 1:
				return $author$project$Main$sample;
			case 2:
				return $author$project$Main$sample2;
			default:
...
var $author$project$Main$dirToMineSymbol = function (dir) {
	switch (dir) {
		case 0:
			return '|';
		case 1:
...
var $author$project$Main$withoutCarts = F2(
	function (carts, mine) {
		withoutCarts:
		while (true) {
			if (!carts.b) {
				...
				var c = carts.a;
				var rest = carts.b;
				var symbol = $author$project$Main$dirToMineSymbol(c.w);
				var _v1 = c.n;
				var x = _v1.a;
				var y = _v1.b;
				var $temp$carts = rest,
					$temp$mine = A4($tortus$elm_array_2d$Array2D$set, y, x, symbol, mine);
				carts = $temp$carts;
				mine = $temp$mine;
				continue withoutCarts;
			}
		}
	});
var $author$project$Main$initModel = F2(
	function (dataSource, removeCrashedCarts) {
		var mine = $author$project$Main$initMine(dataSource);
		var carts = $author$project$Main$findCarts(mine);
		return {
			p: carts,
			Z: 0,
			q: dataSource,
			...
			E: false,
			F: '?',
			Q: A2($author$project$Main$withoutCarts, carts, mine),
			z: true,
			o: removeCrashedCarts,
			H: 0,
			B: $author$project$Main$defaultTickInterval
		};
	});
...
var $author$project$Main$subscriptions = function (model) {
	var tickSub = (model.z || model.E) ? $elm$core$Platform$Sub$none : A2(
		$elm$time$Time$every,
		model.B,
		function (_v0) {
			return 0;
...
var $author$project$Main$updateClear = function (model) {
	return A2($author$project$Main$initModel, model.q, model.o);
};
...
var $author$project$Main$crashesWithAnotherCart = F2(
	function (carts, cart) {
		var count = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (c) {
					return _Utils_eq(c.n, cart.n);
				},
				carts));
		return count > 1;
	});
var $author$project$Main$findCrashes = function (carts) {
	return A2(
		$elm$core$List$filter,
		$author$project$Main$crashesWithAnotherCart(carts),
		carts);
};
...
var $author$project$Main$straightAhead = function (dir) {
	return dir;
};
...
var $author$project$Main$turn = function (switches) {
	switch (switches) {
		case 0:
			return $author$project$Main$turnLeft;
		case 1:
			return $author$project$Main$straightAhead;
		default:
			return $author$project$Main$turnRight;
	}
};
var $author$project$Main$getNextDir = F2(
	function (nextSymbol, cart) {
		var switches = cart.L;
		var dir = cart.w;
		switch (nextSymbol) {
			case '/':
				switch (dir) {
					case 0:
						return $author$project$Main$turnRight(dir);
					case 1:
						return $author$project$Main$turnLeft(dir);
					case 2:
						return $author$project$Main$turnRight(dir);
					default:
						return $author$project$Main$turnLeft(dir);
			...
			case '+':
				return A2($author$project$Main$turn, switches, dir);
			default:
				return dir;
		}
	});
var $author$project$Main$getNextPos = F2(
	function (dir, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		switch (dir) {
...
var $author$project$Main$Right = 2;
var $author$project$Main$getNextSwitches = F2(
	function (nextSymbol, switches) {
		if ('+' === nextSymbol) {
			switch (switches) {
				case 0:
					return 1;
...
var $author$project$Main$moveCart = F2(
	function (mine, cart) {
		var _v0 = A2($author$project$Main$getNextPos, cart.w, cart.n);
		var x = _v0.a;
		var y = _v0.b;
		var nextSymbol = A2(
			$elm$core$Maybe$withDefault,
			' ',
			A3($tortus$elm_array_2d$Array2D$get, y, x, mine));
		var nextDir = A2($author$project$Main$getNextDir, nextSymbol, cart);
		var nextSwitches = A2($author$project$Main$getNextSwitches, nextSymbol, cart.L);
		return {
			w: nextDir,
			n: _Utils_Tuple2(x, y),
			L: nextSwitches
...
var $author$project$Main$posToString = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
...
var $author$project$Main$updateStep = function (model) {
	var steps = model.H;
	var carts = model.p;
	var crashes = $author$project$Main$findCrashes(carts);
	var remaining = A2(
		$elm$core$List$filter,
		function (c) {
			return !A2($elm$core$List$member, c, crashes);
		},
		carts);
	var movedRemaining = A2(
		$elm$core$List$map,
		$author$project$Main$moveCart(model.Q),
		remaining);
	if (model.o) {
		if ($elm$core$List$length(remaining) > 1) {
			return _Utils_update(
				model,
				{p: movedRemaining, H: steps + 1});
		} else {
			var msg = function () {
				if (!remaining.b) {
					...
					var x = _v1.a;
					var y = _v1.b;
					return 'Last cart at ' + ($elm$core$String$fromInt(x) + (',' + $elm$core$String$fromInt(y)));
				}
			}();
			return _Utils_update(
				model,
				{p: movedRemaining, E: true, F: msg});
		}
	} else {
		if (!crashes.b) {
			return _Utils_update(
			...
			var crashPositions = $elm$core$List$sort(
				$elm$core$Set$toList(
			...
			var s = A2(
				$elm$core$String$join,
				' ',
				A2($elm$core$List$map, $author$project$Main$posToString, crashPositions));
			var msg = 'First crash at ' + s;
			return _Utils_update(
				model,
				{p: carts, E: true, F: msg});
		}
	}
};
var $author$project$Main$updateTogglePlay = function (model) {
	if (model.E) {
		var m = A2($author$project$Main$initModel, model.q, model.o);
		return _Utils_update(
			m,
			{F: '?', z: false});
	} else {
...
var $author$project$Main$updateToggleRemoveCrashedCarts = function (model) {
	var removeCrashedCarts = !model.o;
	return A2($author$project$Main$initModel, model.q, removeCrashedCarts);
};
var $author$project$Main$updateUseInput = function (model) {
	return A2($author$project$Main$initModel, 0, model.o);
};
var $author$project$Main$Sample = 1;
var $author$project$Main$updateUseSample = function (model) {
	return A2($author$project$Main$initModel, 1, model.o);
};
var $author$project$Main$Sample2 = 2;
var $author$project$Main$updateUseSample2 = function (model) {
	return A2($author$project$Main$initModel, 2, model.o);
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			...
			case 3:
				return _Utils_Tuple2(
					$author$project$Main$updateToggleRemoveCrashedCarts(model),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(
			...
			case 8:
				return _Utils_Tuple2(
					$author$project$Main$updateUseSample2(model),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
...
var $author$project$Main$ToggleRemovedCrashedCarts = 3;
var $author$project$Main$UseInput = 9;
var $author$project$Main$UseSample = 7;
var $author$project$Main$UseSample2 = 8;
...
var $author$project$Main$getNestedPositions = function (mine) {
	var ys = A2(
		$elm$core$List$range,
		0,
		$tortus$elm_array_2d$Array2D$rows(mine) - 1);
...
var $author$project$Main$isBlank = function (ch) {
	return ch === ' ';
};
var $author$project$Main$isCrash = function (ch) {
	return ch === 'X';
};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Main$toCharElement = F3(
	function (mine, carts, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var cartsAtPos = A2(
			$elm$core$List$filter,
		...
		return $author$project$Main$isCart(symbol) ? A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'color', '#2E8B57'),
			...
			_List_fromArray(
				...
				])) : ($author$project$Main$isBlank(symbol) ? A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('.')
				])) : ($author$project$Main$isCrash(symbol) ? A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'color', '#D2042D'),
					A2($elm$html$Html$Attributes$style, 'background-color', '#CCCCCC')
				]),
			_List_fromArray(
				[
...
var $author$project$Main$view = function (model) {
	...
	var mine = model.Q;
	var nestedPositions = $author$project$Main$getNestedPositions(mine);
	var carts = model.p;
	var nestedElements = A2(
		...
		function (positions) {
			return A2(
				$elm$core$List$map,
				A2($author$project$Main$toCharElement, mine, carts),
				positions);
		},
		nestedPositions);
	var elements = A3(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Advent of Code 2018')
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Day 13: Mine Cart Madness')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2018/day/13')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2018/day/13')
									]))
							]))
					])),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$checked(model.q === 2)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$label,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										model.z ? $elm$html$Html$text('Play') : $elm$html$Html$text('Pause')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(' Remove crashed carts')
									]))
							]))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Steps: ' + $elm$core$String$fromInt(model.H))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
