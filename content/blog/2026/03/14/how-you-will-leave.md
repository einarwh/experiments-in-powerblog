...
Second, there are the repetetive elements. There is no rhyme or alliteration in the traditional sense, but the lines are very self-similar. It resembles a sort of rhyme, but instead of melody and rhythm, it produces a sense of stumbling and fumbling, as if the author were struggling to find the right words, trying many variations over the same theme ("in this talk", "in this session"), occasionally stuttering ("this session we/session we will"), halting just on the curb of saying something important ("learn how to/and how to") or somewhat sheeply acknowledging that "talk we will". The poem also uses a very small number of different words, which gives an impression of being trapped or hampered by lack of imagination in the experimentation. The author seems to doubt their ability to express themselves and to reach their audience.
