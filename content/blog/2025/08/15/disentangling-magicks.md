...
This is what I mean when I say that enterprise programming is not serious. There are more variations of course. I skipped all the variations with the default of _false_ for <span class="inline-code adaptive">AllowEmptyString</span> except one. The only difference is whether or not empty strings are allowed.
